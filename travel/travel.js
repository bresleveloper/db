...
let Travel = function Travel(name, price){
    this.Id = db.travelList.length == 0 ? 3 :
...
db.travelList.push(new Travel('venice', 120))
db.travelList.push(new Travel('south america', 500))
db.travelList.push(new Travel('prague', 150))
db.travelList.push(new Travel('honolulu', 200))
